...
<div id='cssmenu'>
<ul>
	<li><a href="mypage_like">찜</a></li>
	<li><a href="mypage_rsvt">예약 현황</a></li>
	<li><a href="mypage_board">내가 쓴 글</a></li>
	
	<ul>
         <li class='has-sub'id="box"><a href='#'>쪽지함</a>
	        <div style="display:none" id="boxlist">
			<ul>
				<li><a href="msg_boxR">받은 쪽지함</a></li>
				<li><a href="msg_boxS">보낸 쪽지함</a></li>
			</ul>
			</div>
		</li>
        ...
        <li class='has-sub'id="info"><a href="#">회원 관리</a>
	        ...
	        <ul>
				<li><a href="mypageuser">회원 정보</a></li>
	            <li><a href="mypageDelete">회원 탈퇴</a></li>
			</ul>
			</div>
		</li>
	<!-- </ul> -->
